    ...
    >
      <StyledContainer>
        ...
        <Box className={classes.centerItem}>
          <Box
            style={{ display: 'flex', gap: '26px', flex: 1, flexWrap: 'wrap' }}
          >
            <Box className={classes.roundCard} style={{ flex: 1 }}>
              ...
              >
                ...
                <Box
                  className="percent2"
                  style={{ width: '200px', height: '200px', zoom: '40%' }}
                >
            ...
            <Box
              className={classes.addroundcard}
              style={{ flex: 1, padding: '50px 0' }}
            >
        ...
        <Box>
          ...
          >
            LIQUIFY VALIDATORS PERFORMANCE
          </Typography>
            ...
            <Box style={{ overflow: 'auto' }}>
              <Box className={classes.tableBody}>
                ...
                <Typography style={{ flex: 3 }}>
                  Liquify voting power increased to 200,000.0 ROSE
                </Typography>
          ...
          <Box className={classes.roundCard} style={{ width: '70%' }}>
            <Box style={{ padding: '10px' }}>
              ...
              <Typography style={{ color: 'black' }}>
                Relay permormed by All Nodes in the Network
              </Typography>
              <Chart
...
const useStyles = makeStyles({
  ...
  circle2: {
    ...
    strokeDasharray: '440',
    strokeLinecap: 'round',
    strokeDashoffset: (props: any) =>
      'calc(440 - (440 * ' + props.avgPercent + ') / 100)',
    stroke: '#1C39BB',
